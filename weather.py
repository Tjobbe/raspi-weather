...
APIKEY = "127ac0d7b5724335bac0d7b572f33553" #insert API key from https://www.wunderground.com/member/api-keys after registering an account
STATION = "IMORET6"  #insert station ID from https://www.wunderground.com/
ZIPCODE = "GL569PZ" #insert Zip Code  

#get current conditions from weather underground
query = "https://api.weather.com/v3/pws/observations/current?stationId=KMAHANOV10&format=json&units=e&apiKey=127ac0d7b5724335bac0d7b572f33553"
...
wquery = "https://api.weather.com/v3/wx/forecast/daily/5day?geocode=51.991919,-1.692794&format=json&units=e&language=en-GB&apiKey=127ac0d7b5724335bac0d7b572f33553"
...
draw.line((0,0,115,115),inky_display.YELLOW, width=30)
